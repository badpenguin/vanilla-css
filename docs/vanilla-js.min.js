...
function $show(c,d){c.style.display=d?d:""}function $detectSwipe(c,d,a){var b=0,g=0,h=0,k=0;a||(a=50);c.addEventListener("touchstart",function(a){b=a.changedTouches[0].screenX;g=a.changedTouches[0].screenY},{passive:!0});c.addEventListener("touchend",function(c){h=c.changedTouches[0].screenX;k=c.changedTouches[0].screenY;var e=h-b,f=k-g;if(Math.abs(e)>Math.abs(f)){if(Math.abs(e)>a)return 0>e?d("left",c):d("right",c)}else if(Math.abs(f)>a)return 0<f?d("down",c):d("up",c)})}
function $triggerEvent(c,d){var a=document.createEvent("Event");a.initEvent(d,!0,!0);("string"===typeof c||c instanceof String?$(c):c).dispatchEvent(a)}function $on(c,d,a){$all(c).forEach(function(b){b.addEventListener(d,function(c){a(c,b)},!1)})}Array.prototype.unique=function(){var c={};return this.filter(function(d){return c.hasOwnProperty(d)?!1:c[d]=!0})};var lightboxInstanceCount=0;
...
if(c){var d=b.getAttribute("data-title")||b.getAttribute("title")||b.getAttribute("alt");d||(b=$find(b,"img").first())&&(d=b.getAttribute("data-title")||b.getAttribute("title")||b.getAttribute("alt"));a.images.push([c,d])}else console.warn("$lightbox: element has no valid image url",b)},checkImages:function(){$all(c).forEach(function(b){d?$find(b,d).forEach(function(b){a.scanElement(b)}):a.scanElement(b)});1===a.images.length&&(a.singleMode=!0,$addClass(a.modal,"singleMode"))},bootstrap:function(){a.initialized||
(a.checkModal(),a.checkImages(),a.initialized=!0)},switchImage:function(b){a.currentIndex=b;var c=null,d=null;0===a.currentIndex%2?(c=a.modalImage1,d=a.modalImage2):(c=a.modalImage2,d=a.modalImage1);d.setAttribute("title","");a.modalCaption.innerText="";c.src=a.images[b][0];if(b=a.images[b][1])c.setAttribute("title",b),a.modalCaption.innerText=b},show:function(b){a.hide();a.switchImage(b);a.isOpen=!0;$disableScreenScrolling();setTimeout(function(){$addClass(a.modal,"open")},0);a.preloadImages()},
preloadImages:function(){a.images.map(function(a){return a[0]}).unique().slice(1).forEach(function(a){(new Image).src=a})},hide:function(){a.isOpen=!1;$removeClass(a.modal,"open");$restoreScreenScrolling();a.modalImage1.style.opacity="0";a.modalImage2.style.opacity="0"},next:function(){if(!a.singleMode){var b=a.currentIndex+1;if(b<a.images.length)return a.switchImage(b)}a.hide()},prev:function(){if(!a.singleMode){var b=a.currentIndex-1;if(0<=b)return a.switchImage(b)}a.hide()},detectUrl:function(b){b=
b.getAttribute("data-src")||b.getAttribute("href")||b.getAttribute("src");for(var c=0;c<a.images.length;c++)if(a.images[c][0]===b)return c;return!1}};a.insertCss();$on(c,"click",function(b){a.bootstrap();if(0===a.images.length)console.warn("$lightbox: no images found");else{b.preventDefault();b.stopImmediatePropagation();b=b.target;for(var d=a.detectUrl(b);!1===d;){if(b.matches(c)){console.warn("$lightbox: clicked element url not found in main selector");return}b=b.parentNode;if("function"!==typeof b.getAttribute){console.error("$lightbox: cannot find the clicked element in document");
return}d=a.detectUrl(b)}return a.show(d)}});return{}};function $lazyload(c,d){var a={};if(!1 in window)console.warn("$lazyload: not supported.");else return a.images=[],a.preloadImage=function(a){var c=a.getAttribute("data-lazy-src");c&&(a.removeAttribute("data-lazy-src"),$removeClass(a,"lazyload"),$addClass(a,"lazyloading"),a.onload=function(c){$removeClass(a,"lazyloading");$addClass(a,"lazyloaded")},a.setAttribute("src",c))},onPageReady(function(){var b=new IntersectionObserver(function(b,c){b.forEach(function(b){b.isIntersecting&&(a.preloadImage(b.target),
c.unobserve(b.target))})},{rootMargin:"0px 0px 10px 0px",threshold:0});a.images=[];$all(c).forEach(function(c){var d=c.getAttribute("src");d&&(c.removeAttribute("src"),$addClass(c,"lazyload"),c.setAttribute("data-lazy-src",d),b.observe(c),a.images.push(c))});d&&onPageLoad(function(){a.images.forEach(function(b){a.preloadImage(b)})})}),{}}
"IntersectionObserver"in window&&("IntersectionObserverEntry"in window&&"intersectionRatio"in window.IntersectionObserverEntry.prototype&&!("isIntersecting"in IntersectionObserverEntry.prototype))&&Object.defineProperty(window.IntersectionObserverEntry.prototype,"isIntersecting",{get:function(){return 0<this.intersectionRatio}});function $copyright(c){var d;d=c||"This material is copyright by the author - All Right Reserved";document.body.addEventListener("contextmenu",function(a){console.warn(d);a.preventDefault();return!1},!1);document.body.addEventListener("copy",function(a){console.warn(d);a.preventDefault();a.clipboardData.setData("text/plain",d);return!1},!1);document.body.addEventListener("dragstart",function(a){console.warn(d);a.preventDefault();return!1},!1)};function $inViewport(c){c=c.getBoundingClientRect();var d=document.documentElement,a=0.05*(window.innerHeight||d.clientHeight);return 0<=c.top&&c.top+a<=(window.innerHeight||d.clientHeight)}function $windowScrollTop(){return window.scrollY||document.body.scrollTop||document.documentElement.scrollTop}
function $visibility(c,d){var a={};a.options=Object.assign({invisibleClass:"invisible",visibleClass:"animated",loop:!0},d);a.refreshList=function(){$forEach(a.nodeList,function(b,c){if($inViewport(b))$hasClass(b,a.options.visibleClass)||($removeClass(b,a.options.invisibleClass),$addClass(b,a.options.visibleClass));else{if($hasClass(b,a.options.visibleClass)){if(!a.options.loop)return;$removeClass(b,a.options.visibleClass)}$addClass(b,a.options.invisibleClass)}})};a.nodeList=Array.prototype.slice.call($all(c));
